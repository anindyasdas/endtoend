...
from models.stack_gan2.model1 import encoder_resnet1, G_NET1, MAP_NET_IT22, MAP_NET_TI22, MAP_NET_IT2, MAP_NET_TI2
...
#GEN_PATH = '/home/das/dev/unsup/output/flowers_2020_06_13_20_13_28/modeldir/netG_77036.pth' #'netG_139.pth' # netG_100.pth #this is Image t TEXt embedding generator , if not restarted
GEN_PATH = '/home/das/dev/unsup/output/flowers_2020_06_26_21_30_38/modeldir/netGTI_110000.pth' #for GAN #'netG_139.pth' # netG_100.pth #this is Image t TEXt embedding generator , if not restarted
#GEN_PATH = '/home/das/dev/unsup/output/flowers_2020_06_13_20_13_28/modeldir/netG_56063.pth' #for  #'netG_139.pth' # netG_100.pth #this is Image t TEXt embedding generator , if not restarted
#GEN_PATH = '/home/das/dev/unsup/output/flowers_2020_06_13_20_37_46/modeldir/netG_110000.pth'
GEN_PATH = '/home/das/dev/unsup/output/flowers_2020_06_26_21_30_38/modeldir/netGIT_92000.pth' #GAN
...
def load_network():
    ...
    if ind !=None:
        ...
        G_decoder = MAP_NET_IT22() # This the Actual Generator for GAN
    else:
        #G_decoder = MAP_NET_TI2() # This the Actual Generator
        G_decoder = MAP_NET_TI22() # This the Actual Generator for GAN
