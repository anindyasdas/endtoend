...
from models.stack_gan2.model1 import encoder_resnet1, G_NET1, G_NET, D_NET_TEXT, MAP_NET_IT1, D_NET_IMAGE, MAP_NET_TI1
...
IT_GEN_PATH = 'netGIT_55400.pth'#'netGIT_33000.pth' # netGIT_100.pth #this is Image t TEXt embedding generator , if not restarted
#from previous fails should be empty
IT_DIS_PATH= 'netDIT.pth' #netDIT.pth
TI_GEN_PATH= 'netGTI_55400.pth' #netGTI_100.pth
...
log_dir =  'output/birds_2020_07_05_20_01_03'
mkdir_p(log_dir)
