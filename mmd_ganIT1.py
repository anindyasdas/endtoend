...
torch.set_num_threads(5) #number of CPU limit
...
encoder_path='/home/das/dev/unsup/saved_models/flowers/encG_170000.pth' #image encoder
dec_path='/home/das/dev/unsup/saved_models/flowers/netG_170000.pth' #image decoder
text_autoencoder_path = '/home/das/dev/unsup/saved_models/flowers/AutoEncoderDglove100_flowerFalse203.pt' # text auto encoder
GEN_PATH = '' #'netG_139.pth' # netG_100.pth #this is Image t TEXt embedding generator , if not restarted
#from previous fails should be empty
DIS_PATH= '' #'netD_139.pth' 
dset='flowers'#'flowers'#'birds'
...
log_dir =  'output/flowers_2020_06_12_18_32_42'
mkdir_p(log_dir)
...
def load_network(path):
    ...
    D_encoder = MAP_NET_TI1() #Discriminator should be an Auto encoder without noise
    D_decoder = MAP_NET_IT1()#
