...
from models.stack_gan2.model1 import encoder_resnet, G_NET, MAP_NET_IT1, MAP_NET_TI1
...
#encoder_path='/home/das/dev/unsup/saved_models/flowers/encG_175800.pth' #image encoder
#dec_path='/home/das/dev/unsup/saved_models/flowers/netG_175800.pth' #image decoder
...
text_autoencoder_path = '/home/das/dev/unsup/saved_models/birds/AutoEncoderDglove100_newFalse205.pt'
GEN_PATH = 'netG_137471.pth' #'netG_139.pth' # netG_100.pth #this is Image t TEXt embedding generator , if not restarted
#from previous fails should be empty
DIS_PATH= 'netD_137471.pth' #'netD_139.pth' 
dset='birds'#'flowers'#'flowers'#'birds'
...
log_dir =  'output/birds_2020_05_10_09_30_27'
mkdir_p(log_dir)
...
###########################################################################
log_dir1 = 'output/birdsabc'#save the new result
mkdir_p(log_dir1)
...
def load_network(path):
    ...
    D_encoder = MAP_NET_IT1() #Discriminator should be an Auto encoder without noise
    D_decoder = MAP_NET_TI1()#
...
for t in range(start_epoch, args.max_iter):
    ...
    while (i < len(dataloaders_dict['train'])):
        ...
        for j in range(Diters):
            ...
            #x= x[0]
            #print('x:', x.shape)
            #print('max_x:',torch.max(torch.abs(x)))
            ...
            #print('y:', x.shape)
            #print('max_y:',torch.max(torch.abs(y)))
...
#"""
caption_list=['the bird has grayish brown throat, with brown and black wingbars and brown crown.',
              'the bird has grayish brown throat, with brown and red wingbars and brown crown.',
              'the bird has grayish brown throat, with brown and black wingbars and yellow crown.',
              #'the bird has grayish brown throat, with brown and red wingbars and brown crown.',
              'the bird has grayish brown throat, with brown and red wingbars and yellow crown.',
              'the bird has grayish brown throat, with brown and red wingbars and white crown.',
              'this bird has a white belly and breast, and rest is grey with white wingbars.',
              'this bird has a yellow belly and breast, and rest is grey with white wingbars.',
              'this bird has a brown belly and breast, and rest is grey with white wingbars.',
              'this bird has a red belly and breast, and rest is grey with white wingbars.',
              'this bird has a white belly and breast, and rest is grey with red wingbars.',
              'the bird has a white belly, black throat and a white beak.',
              'the bird has a white belly, black throat and a red beak.',
              'the bird has a white belly, black throat and a long beak.',
              'the bird has a white belly, black throat and a short beak.',
              'the bird has a white belly, black throat and a blunt beak.',
              'the bird has a white belly, black throat and a yellow beak.',
              'the bird has a orrange belly, white throat and a white beak.',
              'the bird has a red belly, black throat and a white beak.',
              'this petite bird has a unique patch of yellow atop its black and white head, and small black legs holding its frame.',
              'this petite bird has a unique patch of red atop its black and white head, and small black legs holding its frame.',
              'this petite bird has a unique patch of orrange atop its black and white head, and small black legs holding its frame.',
              'this petite bird has a unique patch of yellow atop its black and white head, and large black legs holding its frame.',
              'this petite bird has a unique patch of yellow atop its black and white head, and long black legs holding its frame.',
              "the bird's eyering is black, while it posseses small thighs and short bill.",
              "the bird's eyering is black, while it posseses large thighs and short bill.",
               "the bird's eyering is black, while it posseses large thighs and long bill.",
               "the bird's eyering is black, while it posseses large thighs and blunt bill.",
               "the bird's eyering is white, while it posseses small thighs and short bill.",
               'this bird has yellow belly, breast, throat, eyebrow with black and grey wings and tail.',
               'this bird has yellow belly, breast, throat, eyebrow with red and grey wings and tail.',
               'this bird has white belly, breast, throat, eyebrow with black and grey wings and tail.',
               'this bird has a black head, white belly, and brown wings.',
               'this bird has a black head, yellow belly, and brown wings.',
               'this bird has a black head, white belly, and brown wings.',
               'this bird has a black head, white belly, and orrange wings.',
               'this bird has a black head, white belly, and white wings.']
